...
<%
	...
	System.out.println(searchKeyword+" - listProduct.jsp");
...
function fncGetProductList(currentPage){
	document.getElementById("currentPage").value = currentPage;		//currentPage의 값을 
			...
			<table border="0" cellspacing="0" cellpadding="0">
				<tr>
					...
					<td background="/images/ct_btnbg02.gif" class="ct_btn01" style="padding-top:3px;">
						<a href="javascript:fncGetProductList(1);">검색</a>	<!-- function fncGetProductList(currentPage)의 인수인 currentPage 값을 입력해주지 않아 발생한 오류 -->
					</td>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin-top:10px;">
	...
	<tr class="ct_list_pop">
		<td align="center"><%=i+1%></td>	<%-- 다음 출력 시 list.size()의 정수가 1씩 증가하여 출력 --%>
		<td></td>
		<td align="left">
	...
	<tr>
		...
		<input type="hidden" id="currentPage" name="currentPage" value=""/>
			<% if( resultPage.getCurrentPage() <= resultPage.getPageUnit() ){ %>
					◀ 이전
			<% }else{ %>
					<a href="javascript:fncGetProductList('<%=resultPage.getCurrentPage()-5%>')">◀ 이전</a>
			<% } %>
